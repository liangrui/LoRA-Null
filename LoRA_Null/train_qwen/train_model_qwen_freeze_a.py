...
# Qwen2 Chat 模板（替代 LLaMA 的 Alpaca 格式）
PROMPT = (
...
def train():
    ...
    if script_args.Null_mode:
        print("Train in Null V2 mode (Qwen2) - freeze ALinear, train BLinear only")
        ...
        for n, p in model.named_parameters():
            if "BLinear" not in n and p.requires_grad:
        ...
        print("Train in Full Finetuning mode (Qwen2)")
        model = transformers.AutoModelForCausalLM.from_pretrained(
            script_args.model_name_or_path,
